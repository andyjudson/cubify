...
Companion to [cubify-lessons.md](cubify-lessons.md) (implementation traps).
...
**Corner slot → position mapping** (verified, see cubify-lessons.md §1):
...
The orientation formula direction (`s - orientation`, not `s + orientation`) is critical — the wrong sign gives scrambled corner colours. See cubify-lessons.md §3.
